...
CREATE TABLE `transaksi` (
  ...
  `id_dettrans` varchar(5) DEFAULT NULL,
  ...
  KEY `id_dettrans` (`id_dettrans`),
  CONSTRAINT `transaksi_fk0` FOREIGN KEY (`id_dettrans`) REFERENCES `detail_transaksi` (`id_transaksi`),
  CONSTRAINT `transaksi_fk1` FOREIGN KEY (`kode_barang`) REFERENCES `tabel_barang` (`kode_barang`),
  CONSTRAINT `transaksi_ibfk_1` FOREIGN KEY (`id_dettrans`) REFERENCES `detail_transaksi` (`id_transaksi`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
